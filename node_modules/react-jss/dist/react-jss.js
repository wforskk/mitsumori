(function (global, factory) {
  ...
  (global = global || self, factory(global.reactJss = {}, global.React, global.jss));
}(this, (function (exports, React, defaultJss$2) { 'use strict';

  var React__default = 'default' in React ? React['default'] : React;
  var defaultJss$2__default = 'default' in defaultJss$2 ? defaultJss$2['default'] : defaultJss$2;
  ...
  */
  ...
  var getManager = function getManager(context, managerId) {
    ...
    if (context.managers) {
      if (!context.managers[managerId]) {
        context.managers[managerId] = new defaultJss$2.SheetsManager();
      }
    ...
    if (!manager) {
      manager = new defaultJss$2.SheetsManager();
  ...
  function functionPlugin() {
    return {
      onCreateRule: function onCreateRule(name, decl, options) {
        ...
        var rule = defaultJss$2.createRule(name, {}, options);
        rule[fnRuleNs] = decl;
        return rule;
      },
  ...
  function observablePlugin(updateOptions) {
    return {
      onCreateRule: function onCreateRule(name, decl, options) {
        ...
        var style$ = decl;
        var rule = defaultJss$2.createRule(name, {}, options); // TODO
  ...
  function () {
    function GlobalContainerRule(key, styles, options) {
      ...
      this.rules = new defaultJss$2.RuleList(_extends({}, options, {
        parent: this
      }));
  ...
  var px = defaultJss$2.hasCSSTOMSupport && CSS ? CSS.px : 'px';
  var ms = defaultJss$2.hasCSSTOMSupport && CSS ? CSS.ms : 'ms';
  var percent = defaultJss$2.hasCSSTOMSupport && CSS ? CSS.percent : '%';
  /**
  ...
  function jssVendorPrefixer() {
    ...
    function prefixStyle(style) {
      for (var prop in style) {
        ...
        var supportedValue$1 = supportedValue(supportedProp, defaultJss$2.toCssValue(value));
    ...
    function onChangeValue(value, prop) {
      return supportedValue(prop, defaultJss$2.toCssValue(value)) || value;
    }
  ...
  var defaultJss = defaultJss$2.create(index$1());
  ...
  var createStyleSheet = function createStyleSheet(options) {
    ...
    var dynamicStyles = defaultJss$2.getDynamicStyles(styles);
  ...
  var useEffectOrLayoutEffect = isBrowser ? React__default.useLayoutEffect : React__default.useEffect;
  var noTheme$1 = {};
  ...
  var createUseStyles = function createUseStyles(styles, options) {
    ...
    function () {
      return React__default.useContext(ThemeContext$1) || noTheme$1;
    } : // $FlowFixMe
    function () {
      return noTheme$1;
    };
    return function useStyles(data) {
      ...
      React__default.useDebugValue(classes); // $FlowFixMe
    ...
    function JssProvider() {
      ...
      _this.createContext = function (parentContext, prevContext) {
        ...
        if (generateId !== undefined) {
          ...
          context.generateId = defaultJss$2.createGenerateId(context.id);
        }
  ...
  JssProvider.propTypes = {
    registry: propTypes$1.instanceOf(defaultJss$2.SheetsRegistry),
    jss: propTypes$1.instanceOf(defaultJss$2__default.constructor),
  ...
  var defaultJss$1 = defaultJss$2.create(index$1());
  ...
  Object.defineProperty(exports, 'SheetsRegistry', {
    enumerable: true,
    get: function () {
      return defaultJss$2.SheetsRegistry;
    }
  });
  Object.defineProperty(exports, 'createGenerateId', {
    enumerable: true,
    get: function () {
      return defaultJss$2.createGenerateId;
    }
  });
